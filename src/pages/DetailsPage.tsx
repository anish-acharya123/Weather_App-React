...
const DetailsPage = () => {
  ...
  const bgImage = {
    backgroundImage:
      "url('https://images.unsplash.com/photo-1482005253821-5d6a2c685879?q=80&w=2057&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
  ...
  return (
    <div className="min-h-screen flex flex-col items-start px-6 w-full gap-6 pt-28 pb-10 ">
      <div
        style={bgImage}
        className="w-full bg-cover bg-center bg-fixed flex justify-center items-center py-20 text-white"
      >
      ...
      <div className="w-full mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            <Icon icon="mdi:map-marker" className="text-red-600 text-[40px]" />
            <p className="text-lg">
